 ...
 * @author arxa
 */
public class WestDirection implements IDirections
{
    public WestDirection(IWords w) 
    {
    ...
    {
        if (Initialization.currentRoom.getStagesArray()[3] == null)
        {
            Output.printNoExit();
        ...
        {
            Initialization.currentRoom = Initialization.currentRoom.getStagesArray()[3];
