 ...
 * @author arxa
 */
public class NorthDirection implements IDirections
{
    public NorthDirection(IWords w) 
    {
    ...
    {
        if (Initialization.currentRoom.getStagesArray()[0] == null)
        {
            Output.printNoExit();
        ...
        {
            Initialization.currentRoom = Initialization.currentRoom.getStagesArray()[0];
